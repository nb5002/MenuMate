...
export function OrderTypeSelector({ onSelect }: { onSelect: (type: OrderType) => void }) {
  return (
    <div>
      ...
      <div style={{ maxWidth: 500, margin: "0 auto", padding: "0 16px", display: "flex", flexDirection: "column", gap: 16 }}>
        <div onClick={() => onSelect("dine_in")} style={{ cursor: "pointer" }}>
          <Card>
        ...
        <div onClick={() => onSelect("takeout")} style={{ cursor: "pointer" }}>
          <Card>
