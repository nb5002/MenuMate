...
// This should be your real deployed URL once live on Vercel.
// For now, it points to your local dev server.
...
export default function AdminQrCodePage() {
  ...
  const handleDownload = () => {
    ...
    link.href = url;
    link.download = "menumate-qr-code.png";
    link.click();
  };
      ...
      <div style={{ padding: 32, display: "flex", justifyContent: "center" }}>
        <Card style={{ textAlign: "center", padding: 40, maxWidth: 400 }}>
          ...
          <p style={{ color: theme.colors.textMuted, marginBottom: 24, fontSize: 13 }}>
            Print this and place it on customer tables. Scanning it opens the digital menu directly.
          </p>

          <div style={{ background: "#fff", padding: 16, borderRadius: theme.radius.md, display: "inline-block" }}>
            <QRCodeCanvas id="menumate-qr" value={MENU_URL} size={220} />
          </div>
